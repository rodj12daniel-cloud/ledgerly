...
export default function App() {
  ...
  if (loading) return <div className="loading-screen" aria-label="Loading Ledgerly" role="status"><div className="loading-brand"><img src="/assets/images/Black%20and%20Gold%20Elegant%20Banking%20Finance%20Logo%20(1).png" alt="Ledgerly" /><div className="loading-bounce" aria-hidden="true"><span className="circle" /><span className="circle" /><span className="circle" /><span className="shadow" /><span className="shadow" /><span className="shadow" /></div><span className="loading-label">Preparing your ledger</span></div></div>

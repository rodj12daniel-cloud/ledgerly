...
export default function Landing() {
  ...
  return <main className={`landing-showcase ${leaving ? 'is-leaving' : ''}`}>
    ...
    {!activeSection && <section className="showcase-hero"><div className="showcase-badge"><strong>NEW</strong><span>Personal finance, made clear</span></div><h1>Ledgerly</h1><p>Soft rolling waves for clearer money.<br />Track your spending with less noise and more intention.</p><div className="showcase-actions"><SpecularButton size="md" radius={16} tint="#fff4a8" tintOpacity={0.72} blur={8} textColor="#17212f" lineColor="#fffbd8" baseColor="#d69e2e" intensity={1.05} shineSize={12} shineFade={35} thickness={1.1} speed={0.35} followMouse proximity={220} onClick={goToRegister}>Get started <span aria-hidden="true">↗</span></SpecularButton><SpecularButton size="md" radius={16} tint="#ffffff" tintOpacity={0.12} blur={8} textColor="#ffffff" lineColor="#ffffff" baseColor="#334155" intensity={1.05} shineSize={12} shineFade={35} thickness={1.1} speed={0.35} followMouse proximity={220} onClick={goToLogin}>Log in</SpecularButton></div></section>}

...
export default function Auth({ mode, onLogin }) {
  ...
  return <div className={`auth-page ${leaving ? 'is-leaving' : ''}`}>
    <aside className="auth-aside">
      ...
      <Link className="brand auth-home-link" to="/" onClick={goHome}><img src="/assets/images/Black%20and%20Gold%20Elegant%20Banking%20Finance%20Logo%20(1).png" alt="Ledgerly" /></Link>
